...
.section-block { margin-bottom: 2.7rem; }
.projects-grid {
  display: grid;
...
.project-img {
  ...
  border-radius: 0.8rem; margin-bottom: 0.7rem; border: 1.5px solid #e3e6eb;
}
.project-title { font-size: 1.23rem; font-weight: 600; color: #304878; margin-bottom: 0.1em; }
.project-desc { color: #333; font-size: 1.06rem; }
.project-impact {
  font-size: 0.97rem; color: #556; background: #e4eaff;
  padding: 0.36em 0.8em; border-radius: 0.7em; margin-top: 0.2em; display: inline-block;
}
.skills-list, .strengths-list, .contact-list { list-style: none; padding-left: 0; }
.skills-list li, .strengths-list li { margin-bottom: 0.3em; padding-left: 1.5em; position: relative; }
.skills-list li:before, .strengths-list li:before {
  content: "✔️"; position: absolute; left: 0; color: #64b6ac; font-size: 0.98em;
}
.skill-grid { display: flex; flex-wrap: wrap; gap: 12px; margin-top: 10px; }
.skill { background-color: #0f172a; color: #fff; border-radius: 8px; padding: 8px 12px; display: flex; align-items: center; gap: 8px; font-size: 0.95em; font-weight: 500; }
.skill img { height: 20px; width: 20px; }
...
<div class="section-block" id="about">
  ...
  <p>
    ...
    accessible, and user-centric solutions. I’m proficient in Python, R, SQL, JavaScript, and I’m skilled at transforming
    complex data into actionable insights using tools like Tableau and SHAP.
  </p>
  <p>
...
<img src="Images/7.png" alt="GMM Clustering of Exoplanets"
...
<img src="Images/8.png" alt="Feature Importance in Random Forest"
     style="width:65%; max-width:800px; height:auto; display:block; margin: 10px 0;">
<figcaption style="font-weight:600; font-size:0.95rem; margin-top:8px; text-align:left;">
...
Analyzed BRFSS data to predict disease risk and optimize health insurance strategies (best accuracy: 84.3%). Used SHAP values for model transparency.  
...
<span style="display:inline-block; margin:0 6px 6px 0; padding:3px 12px; background:#f5f5f5; border-radius:8px; font-size:1.05em;">dplyr</span>
<span style="display:inline-block; margin:0 6px 6px 0; padding:3px 12px; background:#f5f5f5; border-radius:8px; font-size:1.05em;">ggplot2</span>
<span style="display:inline-block; margin:0 6px 6px 0; padding:3px 12px; background:#f5f5f5; border-radius:8px; font-size:1.05em;">caret</span>
<span style="display:inline-block; margin:0 6px 6px 0; padding:3px 12px; background:#f5f5f5; border-radius:8px; font-size:1.05em;">
  <img src="https://avatars.githubusercontent.com/u/37232445?s=200&v=4" style="height:1em;vertical-align:middle;margin-right:6px;"> SHAP
</span>
...
Built a Tableau dashboard visualizing Netflix’s global content, genre trends, and maturity ratings.

<img src="Images/6.png" alt="Netflix Data Visualization Dashboard"
     style="width:65%; max-width:800px; height:auto; display:block; margin: 10px 0;">
<figcaption style="font-weight:600; font-size:0.95rem; margin-top:8px; text-align:left;">
  <strong>Figure:</strong> Netflix Data Visualization Dashboard
</figcaption>
...
<img src="Images/9.png" alt="Home interaction page"
     style="width:65%; max-width:800px; height:auto; display:block; margin: 10px 0;">
<figcaption style="font-weight:600; font-size:0.95rem; margin-top:8px; text-align:left;">
  <strong>Figure:</strong> Home interaction page
</figcaption>

<img src="Images/10.png" alt="Skills interaction page"
     style="width:65%; max-width:800px; height:auto; display:block; margin: 10px 0;">
<figcaption style="font-weight:600; font-size:0.95rem; margin-top:8px; text-align:left;">
  <strong>Figure:</strong> Skills interaction page
</figcaption>

---

### Visualization Module for Python (Research Project)
Developed an interactive visualization tool to help visually impaired users understand data structures like lists and sets in Python.  
